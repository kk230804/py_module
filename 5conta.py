...
Button(root,text="EDIT", font='Helvetica 18 bold',bg='#e8c1c7',command = UpdateDetail, padx=21).place(x= 50, y=195)
Button(root,text="DELETE", font='Helvetica 18 bold',bg='#e8c1c7',command = Delete_Entry).place(x= 50, y=250)
Button(root,text="VIEW", font='Helvetica 18 bold',bg='#e8c1c7', command = VIEW, padx= 18).place(x= 50, y=305)
Button(root,text="RESET", font='Helvetica 18 bold',bg='#e8c1c7', command = Select_set, padx= 9).place(x= 50, y=360)
Button(root,text="EXIT", font='Helvetica 24 bold',bg='tomato', command = EXIT).place(x= 250, y=415)
